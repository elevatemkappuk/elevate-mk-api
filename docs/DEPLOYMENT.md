...
| `BREVO_API_KEY`, `BREVO_SENDER_EMAIL`, `BREVO_SENDER_NAME`, `BREVO_REPLY_TO_EMAIL`, `BREVO_REPLY_TO_NAME`, `BREVO_PASSWORD_RESET_TEMPLATE_ID`, `BREVO_MARKETING_LIST_ID` | Production Brevo credentials, template ID, and approved marketing list ID | Staging Brevo credentials, template ID, and approved marketing list ID |
