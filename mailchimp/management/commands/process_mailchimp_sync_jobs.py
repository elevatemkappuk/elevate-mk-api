...
from mailchimp.jobs import process_mailchimp_sync_jobs


class Command(BaseCommand):
    help = "Process pending durable one-Person Mailchimp synchronization jobs."
    ...
    def handle(self, *args, **options):
        ...
        results = process_mailchimp_sync_jobs(limit=limit)
