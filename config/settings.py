...
BREVO_MARKETING_CAMPAIGN_FOLDER_ID = env("BREVO_MARKETING_CAMPAIGN_FOLDER_ID", default="")
BREVO_MARKETING_STARTER_TEMPLATE_ID = env("BREVO_MARKETING_STARTER_TEMPLATE_ID", default="")
